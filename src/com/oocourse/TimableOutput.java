...
public class TimableOutput {
    private static long startTimestamp = 0L;
    private static final double SECOND_TO_MILLISECOND = 1000.0D;
    public final static ByteArrayOutputStream output;
    private final static PrintStream DEFAULT_PRINT_STREAM;

    static {
        output = new ByteArrayOutputStream();
        DEFAULT_PRINT_STREAM = new PrintStream(output);
    }
    ...
    public static long println(Object obj, PrintStream stream) {
        ...
        stream.println(value.getTimestamp());
